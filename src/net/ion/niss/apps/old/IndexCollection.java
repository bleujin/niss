...
public class IndexCollection implements Closeable {
	...
	private IndexCollection(IndexManager app, IdString colId, Central central, ReadNode colNode) {
		this.app = app ;
		this.colId = colId ;
	...
	public static IndexCollection load(IndexManager app, Central central, IdString colId, ReadNode colNode) throws Exception{
