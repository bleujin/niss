...
public class RepositoryConfigBuilder {
	...
	public RepositoryConfigBuilder node(Node rconfig) throws XPathExpressionException {
		...
		return adminHomeDir(adminNode.getTextContent()).indexHomeDir(indexNode.getTextContent()).wsName(wname);
	}
	...
	public RepositoryConfig build() {
		return new RepositoryConfig(adminHomeDir, indexHomeDir, wsName);
	}
