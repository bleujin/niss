...
import net.ion.niss.apps.loader.ExceptionHandler;
import net.ion.niss.apps.loader.InstantJavaScript;
...
public class LoaderWeb implements Webapp {
	...
	@POST
	@Path("/{lid}/run")
	public String run(@PathParam("lid") String lid, @FormParam("content") String content, @Context HttpResponse response) throws IOException, ScriptException{
